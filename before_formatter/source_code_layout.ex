defmodule SourceCodeLayout do
	...
	def single_line_2(%{}), do: :very_long_line_here_do_you_understand_very_long_line_here_do_you_understand
	...
	def single_line_3(%{}), do: :very_long_line_here_do_you_understand_very_long_line_here_do_you_understand
	...
	def prefer_pipe(some_data) do
		List.first(other_function(some_data))
	end
	...
	def pipe_bare_variable(some_data) do
		other_function(some_data) |> List.first()
	end
